...
To turn knowledge gathered from different places into usable understanding, we need to see how its parts connect—and how new experience can change those connections.
...
Second-order understanding, as this book uses the term, concerns these arrangements: how material becomes judgement, how judgement leads into action, and how results can change the methods that produced them. Even the rules by which we detect error, learn, and revise are open to examination.
...
We begin with a horse believed to understand arithmetic. He repeatedly gave correct answers, yet researchers gradually found their origin more revealing than the answers themselves. Ways of recording the world, other people's knowledge, and our own purposes enter through this inquiry. Part One introduces the whole framework: what a transformation preserves, whether different kinds of work can be composed, and whether new results can return to change earlier methods. Subsequent chapters develop these three relations until bodies, tools, and institutions enter the same picture—and the picture itself comes under examination.

After reading, you can practise tracing an answer back through its making, distinguishing a lack of data or method from missing conditions or an opportunity to reconsider the purpose. In unfamiliar fields, you can identify which earlier methods are worth borrowing; in your own reactions, you can see more of how feeling, habit, and environment work together. The book offers a way to connect these tasks: identify what a piece of knowledge preserves, bring different people's abilities to bear on the problem, and let the results of action reach the places that need to change. It cannot make every decision for you. It can help you explain your grounds for proceeding now, and where you might begin again later.

## Part One — Understanding as a Series of Transformations
{: #part1 }

> How is an answer formed, and how does it connect to another? We begin with Hans's hoofbeats, then unfold the framework as a whole.
{: .prompt-info }

### 1 — From Material to Judgement
{: #s2 }
...
If knowing cannot be separated from human capacities and methods, on what grounds can we judge one account more reliable than another? The geometry in Chapter 5 will bring new difficulties to one kind of knowledge Kant relied on.
...
Counting hoofbeats alone could not bring about this change of question. The researcher changed the tests and left records that others could check. How material is recorded, how records support explanations, and how explanations are tested against new results already form a connected sequence here. The next chapter brings these relations together to ask whether they can carry us into other problems.

### 2 — Preservation, Composition, and Return
{: #s3 }

Hans's hoofbeats were counted as an answer; the answer was read as evidence of arithmetic ability. After Pfungst changed the tests, the same hoofbeats received another explanation. The turning point in the previous chapter lay between these steps.

For the moment, we can lay out the researcher's work: obtain material, keep records, make comparisons, form a judgement, and arrange another test. As new results arrive, the original explanation may change. Sometimes what is tested, and how it is recorded, must change too.

**Material → Representation → Operation → Judgement and action → Results and new material.**

This sequence offers an initial map. Material consists of the experience and records available on this occasion. Representation preserves some of their differences; operations let us compare, infer, rearrange, or try things out. Judgement can guide action, which changes the environment and brings new material. The knower's abilities, the environment, and available resources support the whole process; purpose gives particular differences and results their importance.

The arrows do not mean that everyone settles on a purpose first and then thinks in order. We may begin doing something before discovering what we want to ask; a skilled body need not first translate what it perceives into sentences. The map helps locate dependencies, without requiring every act of understanding to follow one procedure. Some results arrive much later; others can no longer be checked. These missing routes of return also need to remain visible. Purpose and judgement appear in the map because we are examining how understanding works. This does not give the stones, rivers, or diseases being understood purposes or cognition of their own.

#### Can a Difference Survive the Next Step?
{: #s3-1 }

Preservation, composition, and return are the three relations this book uses to examine transformations. Returning to Hans makes their different questions clearer.

**Preservation** asks what remains distinguishable after a change of form. If the record retains only the number of correct answers, whether the questioner knew the answer disappears from the data. To distinguish arithmetic from responses to bodily signals, that difference must survive. It may matter less for another purpose; what should be preserved always needs to be explained in relation to use.

**Composition** asks whether what one step supplies is enough to support the next. The right number of taps supports the claim that the horse performed correctly in these circumstances. Reaching the claim that he understood arithmetic requires further work to rule out other explanations. Each step may look plausible on its own, while the combined inference outruns the evidence at the point of connection.

**Return** asks whether later discoveries have a route back to change earlier methods. A failed test can be recorded as a fluke, or it can prompt a review of categories and a new experimental design. When Pfungst brought the questioner's knowledge and the horse's line of sight into the comparison, he changed more than the answer to a single problem.

Each relation has its own work to do. Complete records do not guarantee sound connections between inferences; recognising a gap does not guarantee that anyone can change the test. Conversely, even a willingness to repeat the work cannot recover every difference once the original records are gone. Return means a route for investigation and revision, not a promise that time or information can flow backwards.

#### What Changes at the First and Second Orders?
{: #s3-2 }

Testing one more problem by the existing method may change our judgement of that performance. Including the questioner's knowledge in the test changes how the judgement is formed. **First-order understanding uses existing methods to address things; second-order understanding also makes the methods of forming, connecting, checking, and revising judgements open to change.**

The distinction is not one of profundity. Thinking through the same answer again may leave the method untouched; changing a field in a record may enable the entire test to distinguish something previously invisible. Second-order understanding must make a difference of this kind.

Nor are the rules for changing methods exempt. Is an anomaly enough to justify repeating a study? Who can raise it, and who decides whether it deserves attention? Arrangements that repeatedly miss important problems also need reconsideration. We need not ascend through endless levels before every action. A concrete difficulty can guide us to the level that needs another look.

#### How One Transformation Hands Over to Another
{: #s3-3 }

Imagine a water-supply investigation; for now, consider only how its data connect. Household addresses are mapped, drinking-water sources are classified, and deaths are compared across categories. The addresses must correspond to the period under investigation, the categories to the sources being studied, and the death counts to appropriate denominators. If any connection goes wrong, precise calculations may answer a different question.

A dataset counting people cannot be compared directly with one counting households supplied merely because both columns say 'mortality rate'. Nor may an unanswered interview quietly become a negative response when tables are merged. Such small handovers determine whether individually useful tasks can combine into a greater ability. Snow's investigation in Chapter 6 will make this concrete.

Comparing groups separately before assembling an overview may preserve very different possibilities from compressing everything into an average and only then asking about group differences. Identical names do not guarantee identical contents; a change of order may also lose relations we need.

The unity sought here rests on these traceable relations. Mathematical proof, historical inquiry, and bodily practice each involve indispensable work. We want to study how they develop abilities, how they can connect under suitable conditions, and how new results can change established methods. Calling them all 'information' is far from enough.

#### Where to Begin Checking
{: #s3-4 }

Six questions can help locate the work needed for a particular judgement. They indicate places to examine and may be omitted, divided, or rephrased as circumstances require.

Begin with purpose: **what do we want to understand or accomplish?** Predict an outcome, explain a cause, complete an action, understand someone, or reconsider what is worth pursuing? Clarifying the use helps establish what would count as a gain.

Locate ability and circumstance: **who is understanding, and who bears the consequences?** Knowers bring existing abilities, positions, and limits. Those affected may have material absent from the framework, yet may never have had a chance to help define the problem.

Follow the material: **which differences does the representation preserve?** Tables, maps, statements, sensations, and models retain particular relations. Establish where the material came from and how it was selected, then examine what the representation keeps. Once a needed distinction has been merged away, the representation alone cannot restore it.

With a representation in place: **which operations are available?** Some representations suit comparison, others proof; some support rapid action, others the reconstruction of someone's reasons. A framework's contents must be considered alongside the work they enable.

Examine what supports that work: **on which conditions does the ability depend?** Sources, environmental regularities, time, skills, tools, and cooperation may all contribute to success. When conditions change, past performance must be checked against the new use.

Finally, trace the destination of revision: **when results return, which level can change?** Sometimes a number needs correction; sometimes a representation, skill, or procedure needs changing. New experience can also undermine the original purpose. If a framework permits revised answers but forbids reconsidering questions, what it never asked will struggle to enter learning.
...
These six questions do not occupy the same level. Representations and operations are components of a process; knowers, environments, and resources support their operation. Purpose shapes selection and evaluation; revision can act on any of these. Restoring the questions to their relations within transformations helps us see what else may need to change when an answer changes.

This map gives the reading ahead a direction. Part Two examines what transformations preserve. Part Three asks who and what sustain the ability to understand. Part Four brings judgement into contact with purpose and cost. Part Five asks how results can change the conditions that produce understanding. Each part unfolds the same relations while putting this initial map to further tests.

We begin with a transit map. The city remains the same; the lines on paper change, and with them what people can do.

## Part Two — What Is Preserved, What Is Omitted
{: #part2 }

> A representation makes certain tasks possible and determines which differences disappear. Whether a method can be borrowed depends on whether the relations needed for its new use survive the transformation.
{: .prompt-info }

### 3 — Representation: Giving the World a Form We Can Work With
{: #s4 }
...
_Figure 3.1　Historical maps from different years. Left: the 1908 map, identified as public domain in its file record. Right: the second edition of Beck's 1933 map. Image credit: David Rumsey Map Collection, David Rumsey Map Center, Stanford Libraries, CC BY-NC-SA 3.0. The network itself also changed between these dates.[^map1908][^map1933]_
...
_Figure 3.2　Two drawings of the same connections. This hypothetical network was made for the book; it is not London's railway. The right-hand drawing groups locations by minimum steps: A; B and C; D and E; F and G; H._
...
Changing the form on paper can increase ability. But if a later step needs a difference already omitted, no ease of operation can retrieve it. The next chapter follows this boundary: when does omission enable us, and when does it leave us unable to see?

### 4 — Omission: A Source of Ability and a Boundary
{: #s5 }
...
_Figure 4.1　Hiding detail does not sever dependence. Arrows indicate support and influence, not inevitable failure on every use. Drawn for this book._
...
_Figure 4.2　Identical summaries can represent situations requiring different answers. These hypothetical numbers support an argument; they are not measurements. Drawn for this book._
...
Chapter 3's numerical notations remind us that improvement need not involve deletion. Two notations can preserve a quantity while changing computational difficulty. The need to select does not prove that every change of representation loses information.
...
Viewed through transformations, omission is especially difficult because a gap may become apparent only after a handover. When a previously adequate representation enters a new environment, the next task is to establish which conditions remain and which have changed.

### 5 — Conditions and Transfer: How Far Can a Method Travel?
{: #s6 }
...
_Figure 5.1　The left triangle has straight sides in a Euclidean plane; the right has short great-circle arcs on an ideal sphere. Their sums are 180° and 270°. Mathematical constructions drawn for this book._
...
An intervention may also have several effects at once. The benefit of one can be offset by another, leaving the overall result different from what was expected. Explaining one causal pathway therefore does not remove the need to compare important outcomes directly. The clinical trial in Chapter 14 will make this distinction concrete.

Even partial mechanistic knowledge may not cover a new situation. Users' anomaly reports, raw data, and alternative measurements can reveal unforeseen differences. Chapter 4 discussed preserving these means of correction. Known ranges of use can also be documented more precisely.
...
What a representation preserves must be considered with its conditions; establishing those conditions depends in turn on who obtains the data and who can recognise differences. The apparently simple 'knower' in our framework now needs to be opened up. The next part begins with Snow's investigation, tracing how one person's knowledge connects with the work of many.

## Part Three — Where Does the Ability to Understand Reside?
{: #part3 }

> Material passes through other people's hands, methods descend from earlier work, and skills develop between bodies and environments. Following these handovers reveals the actual reach of an ability.
{: .prompt-info }

### 6 — How Other People's Knowledge Becomes Our Ability
{: #s7 }
...
_Figure 6.1　Snow's map of the 1854 Broad Street cholera outbreak. Black strokes mark deaths; their clustering provides clues for investigation. Original: John Snow, public domain; digital image details are given in the sources.[^snowmap]_
...
These handovers let us borrow ability, but they also reveal a difficulty: other people's words may not fit directly into familiar categories. For understanding to connect, we may first need to find out what question the other person is answering.

### 7 — Other People Are Not Objects Awaiting Decoding
{: #s8 }
...
_Figure 7.1　Opposition can concern different relationships. This hypothetical proposal develops the table; it is not a park survey. Drawn for this book._
...
Understanding someone requires allowing their words to change our categories. Learning from predecessors makes a similar demand. We can quote the sentences they left, but still need to reconnect them to the questions, reasons, and conditions from which they arose.

### 8 — Connecting Earlier Understanding to Your Own
{: #s9 }
...
_Figure 8.1　Learning from others and passing learning on. Explicit reasons and shared practice can alternate. Checking and practice can reveal errors, but inherited material may remain uncorrected. Drawn for this book._
...
Lean checks whether a supplied proof establishes the formal proposition under the chosen logic and axioms. This still relies on the checking tool operating correctly. Suitability for a real-world question requires another inquiry. A bridge model omitting an important loading condition gains no account of that condition merely from a verified internal proof. Chapter 4's question returns: what was omitted, and does later use require it?
...
_Figure 8.2　Investigating an author's meaning. Text and background support an interpretation, then questioning, comparison, or practice tests it. New material can require rewriting an apparently fluent reading. Drawn for this book._
...
Whether earlier achievements become part of our ability depends on what we receive: conclusions alone, or also the conditions, operations, and checks that produced them. Next comes a form of transmission less easily put into words. Someone may know what to do before the body has learned it; another may act correctly before gradually finding words for what they recognised.

### 9 — Bodies, Skills, and Tools
{: #s10 }
...
Conversely, explicit comparison reveals what impressions omit. Chapter 4's two equal averages concealed the presence of a value below twenty until the original numbers were displayed. A general impression of similar average performance cannot answer that question. Feeling and inference can each miss or reveal differences.
...
_Figure 9.1　How feeling, inference, and checks assist one another. Outcomes, example comparisons, and independent measurement can revise judgement. Delayed or incomplete feedback may leave errors unlearned. This is a learning diagram, not a map of brain regions. Drawn for this book._
...
#### Where Do We Draw the Boundary of an Ability?
{: #s10-8 }

The distinctions learned by the body already prevent us from judging understanding solely by reasons that can be stated. Where, then, does this ability reside? An action may depend on sensations its performer has never noticed. When those sensations disappear, something external may take over part of the work.
...
Figure 9.2 sets two processes side by side. The left shows local clotting; the right shows interactions among sensory information, neural circuits, and responses. Both can operate without a conscious decision at that moment, but their mechanisms of initiation, regulation, and limitation differ.

![Left: local processes involving vascular injury, platelets, and clotting proteins. Right: mutual regulation among sensory inputs, spinal and brainstem circuits, broader brain networks, and responses.](/assets/img/book/en/fig-07-body-regulation.svg){: width="1200" height="900" }
_Figure 9.2　Functional relations among different mechanisms. Drawn from this chapter's sources to compare division of labour and mutual regulation, not as a complete anatomical diagram. Arrows do not correspond individually to neural pathways. Clotting, reflexes, and conscious activity retain their distinct mechanisms._
...
This chapter has redrawn the boundaries of ability through skill, sensation, and external assistance, while retaining their different mechanisms. What matters is which relations support what we can do, and what can take over when a link is missing. Bodily divisions of labour cannot decide what that ability should serve. The next part therefore begins with purpose.

## Part Four — Understanding Enters Action
{: #part4 }

> The same understanding can serve different purposes and leave different people bearing the costs. When judgement begins to direct action, time, values, and power enter the framework.
{: .prompt-info }

### 10 — Purpose: What Determines Success?
{: #s11 }
...
Whether an omission causes trouble still depends on later use. Some representations chiefly rearrange information to ease calculation or retrieval, without necessarily deleting content. Chapter 3's networks and numbers have already shown this. To evaluate a representation, we must consider what it preserves, which operations it permits, and what we currently need.
...
Purpose gives differences their weight and success its criteria. Yet comfort, accurate prediction, and fair treatment remain different gains. If all are called 'useful', those distinctions still need to be made clear.

### 11 — Usefulness: What Understanding Enables Us to Do
{: #s12 }
...
Using an example to support a decision adds another responsibility. As Chapter 3 discussed, a project succeeding after many years does not alone establish that ours should continue. The story's encouragement remains real. But we must spend the next year ourselves, so the reasons must return to our circumstances.
...
Comfort, prediction, understanding, and cooperation offer different abilities. Identifying the use is not the end: how much time remains to acquire this ability, and how much checking can we afford? Sometimes the hardest step is to stop analysing before understanding is complete.

### 12 — Decisions in Limited Time
{: #s13 }
...
_Figure 12.1　Immediate action, later analysis, and long-term learning support one another. Lines are not proportional to duration and prescribe no uniform timetable. Drawn for this book._
...
Individuals do not always decide alone when analysis stops. Assessment deadlines, rewards, and authority keep some questions open while closing others early. Once understanding enters institutions, which results can return to change methods becomes a question of power.

### 13 — Indicators, Power, and Those Affected
{: #s14 }
...
_Figure 13.1　Assessment changes assessed behaviour. Meeting targets must be checked against actual service and additional costs; feeding back only target figures can omit both. Drawn for this book._
...
_Figure 13.2　How detected problems reach action. The right adds paths for original records and supplementary accounts to decision-makers, with responses returned to the front line. Dashed lines mark additions. This hypothetical design is not Wells Fargo's organisational chart._
...
Results may return to an institution yet change only its techniques for meeting targets. We next need to distinguish failures calling for more data from those calling for a different method, and ask what evidence would justify that change.

## Part Five — Understanding That Can Revise Itself
{: #part5 }

> Results do not change methods by themselves. Moving from the discovery of error to new arrangements for judgement requires evidence, channels, and an actual capacity to make changes. This framework must face the same examination.
{: .prompt-info }

### 14 — How Failure Finds Its Way Back
{: #s15 }
...
Return to the aircraft case at the beginning of this chapter. What would it mean to have learned from it? 'Notice what you cannot see' may offer little guidance when another dataset arrives. A more precise question remains available: what determines whether a case enters the data, and could the absent cases change the answer we seek?
...
Learning from failure requires finding the missing people and recovering distinctions that were not retained. Whether this work can happen depends on data and authority still being available. Beyond today's answers, we are deciding what tomorrow's error detection can draw on.

### 15 — Preserving Tomorrow's Capacity to Understand
{: #s16 }
...
Snow's investigation combined households, landlords, and water records. Chapter 8's readers acquired methods by following reasons. Chapter 13's services reconsidered provision through difficulties their forms could not record. Each expands what successors can ask, check, and do. Existing answers may fail less often; new questions also become possible.
...
Preserving these abilities is a direction this book is prepared to defend. A final set of questions remains: which values support this choice, where does it connect with existing methods, and what can the framework not yet do?

### 16 — The Framework Within the Framework
{: #s17 }

Studying how understanding works does not place us outside it. This book, too, selects material, arranges relations, and makes evaluations. Having asked other methods to explain what they can do, it owes the same account of its own uses, commitments, and boundaries.

The previous chapter's case for preserving future error detection includes our concern for losses, costs, and rights. These positions cannot be hidden in a flowchart as though its arrows had deduced them. At the end, we need to bring them into view and explain which traditions the framework inherits from, and what further work it proposes.
...
Chapter 12's stopping question remains: what might further analysis change, and how much time is worthwhile? No effect on immediate action does not make a question permanently unworthy. Present decisions and long inquiry can have separate time.
...
Chapter 11 separated factual truth, functional effects, and grounds for adoption. A transit map shows how these evaluations work together.
...
#### Connections with Existing Traditions
{: #s17-4 }

Important traditions already put the observer back into the problem, connect criticism with revision, and move between judgements and principles. If this book merely renames that work, its claim to unity adds nothing. Comparison should begin by acknowledging paths already travelled.

In 'Cybernetics of Cybernetics', Heinz von Foerster directs second-order cybernetics towards systems that observe. How observers describe, distinguish, and set purposes enters the inquiry rather than remaining outside its description.[^cybernetics] This book follows that turn: the knower's choices and abilities also belong in the analysis. It does not, however, infer from the dependencies of observation that every account is equally valid. We can still compare data, examine inferences, and allow results to count against a claim. This practical analysis does not require readers first to accept a single answer about the ontological status of mind or reality.

In studying the social conditions of science, Helen Longino identifies practical requirements for criticism: forums in which it can be offered, responsiveness to it, publicly discussable standards, and the inclusion of relevant perspectives without arbitrary exclusion by power. This does not give everyone equal expertise on every issue.[^longino] The preceding two chapters' concern with challenge and revision has a direct affinity with this tradition. Following it, we ask how the distinctions raised by criticism enter representations, which operations receive them, and who ultimately changes a decision. Adding an opportunity to speak and changing a route for handling problems remain separate achievements to establish.

Reflective equilibrium moves among particular judgements, principles, and relevant theories, adjusting them towards better mutual support. It permits revision at either end, rather than always making cases yield to principles.[^equilibrium] This helps illuminate the chapter's discussion of values. We also need to trace which material gets a chance to become a considered judgement, and how revised claims enter action. Someone may rethink fairness while a form still offers no place to describe unfair treatment. The reconciliation of reasons must also connect with changes in tools and institutions.

Each tradition contains richer arguments than can be presented here. A few comparisons cannot establish that one has superseded another. This book's chosen task is to examine the selections made by representations, the handovers between methods, and the conditions of revision together, bringing bodily skills, individual judgements, and collective institutions within that inquiry. How much ability this combination adds must be shown by its results, not proved by declaring a difference from predecessors.

Category theory in mathematics inspires attention to relations and composable transformations. Here, however, 'composition' has not received an equally rigorous formal definition. Nor can one symbol dispense with the different preservation conditions required by different uses. This book offers a framework for philosophical analysis that can be examined and revised. Any future formalisation would still need to specify its objects, transformations, rules of composition, and conditions of validity.

#### Coherence and Coverage Require Different Tests
{: #s17-5 }
...
Coverage requires another kind of test. This book hopes these relations can analyse a broad range of activities of understanding, but has not proved that they encompass every possible kind. Putting anything new under 'other' only demonstrates a broad category; expanding after criticism only demonstrates revisability. A claim to wide applicability requires examination across fields: can the framework preserve important differences, locate specific gaps, and enable further work?
...
![The inner loop runs from problem and method to action and result. The outer loop returns unexpected material to original purposes and standards, revising reasons for choosing methods when necessary.](/assets/img/book/en/fig-18-method-review.svg){: width="1200" height="840" }
_Figure 16.1　Sometimes answers need changing; sometimes the way of judging needs reconsideration. The outer loop permits review of existing arrangements without demanding that every action rebuild the entire framework. Drawn for this book._

Requiring infallible standards before every beginning recreates Chapter 12's endless analysis. Judgement proceeds with available knowledge while preserving places for later correction.
...
This framework is no exception. If preservation, composition, and return become repeated words that help neither distinguish differences, connect work, nor change methods, they need rewriting. If the six questions merely prolong discussion, use them less. If new experience is repeatedly misclassified, change the categories. Coherence requires particular checks; applicability requires different problems to test it. Willingness to revise allows this work to continue; it does not prove the work complete.
...
The sources below support the historical accounts, research, interviews, classical references, and literary retellings in the text. Images have separate captions and credits distinguishing historical reproductions from diagrams drawn for this book. Literary retellings follow the original narratives and ideas; interview material retains its character as reported experience and retrospective reconstruction. Explicitly hypothetical cases test reasoning without posing as actual events. The evaluative claims and institutional proposals in Chapters 15 and 16 are positions advanced and defended by this book, not conclusions jointly endorsed by these sources.
...
[^map1908]: *Underground Railways of London* (1908). [Image file and rights information](https://commons.wikimedia.org/wiki/File:Tube_map_1908.jpg). The file page lists the author as unknown and the work as public domain; the 1,932 × 1,530 pixel image supplied is used. It serves as a historical map from before Beck's design and is not treated as a controlled comparison of the same network.

[^map1933]: Henry Charles Beck, *London Underground Transport* (1933), the second edition of that year; collection number 8727.003. [David Rumsey collection record and licence details](https://archive.org/details/dr_london-underground-transport-8727003). Image credit: David Rumsey Map Collection, David Rumsey Map Center, Stanford Libraries. The image is used under the CC BY-NC-SA 3.0 licence listed by the collection; it has not been cropped, recoloured or redrawn. This licence for the digital file applies separately to the right-hand image of Figure 3.1.

[^hans]: Oskar Pfungst (1911). *Clever Hans (The Horse of Mr. von Osten): A Contribution to Experimental Animal and Human Psychology*. Translated by Carl L. Rahn. Henry Holt and Company; the German original was published in 1907. [Full text of the original study](https://www.gutenberg.org/files/33936/33936-h/33936-h.htm). The whispered addition in Chapter 1 follows the book's experiments in which "the questioner does not know the answer": 3 correct out of 31 tests with unknown sums, 29 correct out of 31 tests with known sums. For the postural and head signals see the book's analysis of movements; these figures are limited to that set of tests.

[^snow]: John Snow (1855). *On the Mode of Communication of Cholera*, 2nd ed. John Churchill. [Original text of the Broad Street investigation](https://epi-snow.ph.ucla.edu/Stream2_BSPoutbreak_a.html), [original text of the water-company comparison](https://epi-snow.ph.ucla.edu/Stream3_GrandExperiment_a.html), hosted by the UCLA John Snow site. Chapter 6 retells the workhouse, the brewery, the Hampstead case and the water-supply investigation from the book. The figure of 535 refers to the workhouse's resident population; the eight- to ninefold figure compares deaths per 10,000 supplied houses in the first seven weeks of the outbreak, not the risk per 10,000 people. The book also records supplies not yet identified and cases that were estimated.

[^alice]: Lewis Carroll (1865). *Alice's Adventures in Wonderland*, Chapter III, “A Caucus-Race and a Long Tale”. [Original text](https://www.gutenberg.org/files/11/11-h/11-h.htm). Chapter 10 retells the episode in this book's own words; the reading of purpose, evaluation and the allocation of costs is this book's argument.

[^beck]: Transport for London Corporate Archives. *Research Guide No. 24: Harry Beck*. [Archive research guide](https://tfl.gov.uk/cdn/static/cms/documents/research-guide-24-harry-beck.pdf); London Transport Museum, [the 1933 pocket Underground map in the collection](https://www.ltmuseum.co.uk/collections/collections-online/maps/item/1983-415). Chapter 3 keeps the history of the design and its adoption, and does not merge the payments for different commissions into a single anecdote.

[^af447]: Bureau d'Enquêtes et d'Analyses (2012). *Final Report on the Accident on 1st June 2009 to the Airbus A330-203 Registered F-GZCP Operated by Air France, Flight AF 447 Rio de Janeiro–Paris*. [Investigation report, preserved by the FAA](https://www.faa.gov/sites/faa.gov/files/AirFrance447_BEA.pdf). For the sequence of control inputs and warnings see pages 21–24 of the report; for the analysis and conclusions see sections 2 and 3. Chapter 4 uses it to distinguish the control inputs, the validity of the airspeed readings, the state of the aircraft and the crew's understanding; the problem of hand-over at the interface is the angle of analysis this book draws from it.

[^andersen]: Hans Christian Andersen, “The Little Match Girl”, in *Andersen's Fairy Tales*. [Gutenberg English translation](https://www.gutenberg.org/files/1597/1597-h/1597-h.htm). Chapter 11 retells the story in this book's own words, keeping the sequence of the stove, the roast goose, the Christmas tree, the star and the grandmother, and the ending in which she is taken to God while what the street sees is a death.

[^wald]: Abraham Wald (1943; reprinted 1980). *A Method of Estimating Plane Vulnerability Based on Damage of Survivors*. Center for Naval Analyses; originally a set of memoranda for the Statistical Research Group at Columbia. [Reprint in the archive](https://archive.org/details/DTIC_ADA091073), [transcription of the text](https://archive.org/download/DTIC_ADA091073/DTIC_ADA091073_djvu.txt). Chapter 14 follows its research question, estimating loss probabilities from survivor data, and does not add dramatised dialogue between officers and mathematicians. The popular version, "add armour only where the bullet holes are fewest", does not state the assumptions Wald's estimate relied on. The chapter keeps the distinction between the probability of being hit and the probability of surviving a hit, and does not treat the count of holes as a complete rule for armour design in itself.

[^rashomon]: Akira Kurosawa (director), Shinobu Hashimoto and Akira Kurosawa (screenplay), *Rashomon* (1950), adapted from the work of Ryūnosuke Akutagawa. [Criterion film record](https://www.criterion.com/films/307-rashomon), Stephen Prince's [review and structural analysis](https://www.criterion.com/current/posts/195-the-rashomon-effect), [plot summary of the film](https://en.wikipedia.org/wiki/Rashomon). What Chapter 7 retells is the film: the shelter from the rain under the gate, the differing causes of death in the testimonies, the woodcutter's changed account, the accusation over the dagger and the adoption of the child; the film's framing plot does not belong to the content of Akutagawa's original “In a Grove”.

[^zhuangzi]: *Zhuangzi*, [“The Mountain Tree”](https://zh.wikisource.org/zh-hant/%E8%8E%8A%E5%AD%90/%E5%B1%B1%E6%9C%A8) and [“The Secret of Caring for Life”](https://zh.wikisource.org/zh-hant/%E8%8E%8A%E5%AD%90/%E9%A4%8A%E7%94%9F%E4%B8%BB). Chapter 7 retells the empty boat and Chapter 9 retells Cook Ding; the intellectual and literary context is kept, and this book's contemporary extension is kept apart from the physiological research.

[^darwin]: Charles Darwin (1887). *Autobiography*, edited by Francis Darwin in *The Life and Letters of Charles Darwin*. [Text of the autobiography](https://www.gutenberg.org/files/2010/2010-h/2010-h.htm). Chapter 8 follows his retrospective account of how reading Malthus in 1838 combined with his earlier observations. For the background on population and the means of subsistence see Thomas Malthus, [Chapter 1 of *An Essay on the Principle of Population* (1798)](https://www.gutenberg.org/files/4239/4239-h/4239-h.htm). After forming his preliminary explanation, Darwin went on gathering evidence and developing the theory.

[^con]: Raymond Chen (2003). “What's the Deal with Those Reserved Filenames Like NUL and CON?” [An engineer's historical explanation](https://devblogs.microsoft.com/oldnewthing/20031022-00/?p=42073); Microsoft, [Naming Files, Paths, and Namespaces](https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file). Chapter 8 distinguishes the historical explanation from the current rules of each interface; the documentation was checked on 8 September 2026.

[^apollo]: NASA, *Apollo 11 Lunar Surface Journal*, [descent and landing transcript](https://www.nasa.gov/wp-content/uploads/static/history/alsj/a11/a11.landing.html), especially reports from mission time 102:38:26, clearance at 102:38:53, and subsequent alarms; Fred H. Martin (1994), [a participant’s retrospective account of the program alarms](https://www.nasa.gov/wp-content/uploads/static/history/alsj/a11/a11.1201-fm.html). The preface and Chapter 12 follow the transcript and participant recollections. Ground engineering roles and post-landing investigation also draw on editorial notes and Martin’s account.

[^deafferentation]: J. D. Cole & E. M. Sedgwick (1992). “The Perceptions of Force and of Movement in a Man without Large Myelinated Sensory Afferents below the Neck.” *The Journal of Physiology, 449*, 503–515. [Abstract of the study](https://europepmc.org/article/MED/1522522). Chapter 9 is limited to this case's loss of sensation, visual feedback and motor performance, and does not extend the case's results into a condition shared by all sensory disorders.

[^wellsfargo]: Consumer Financial Protection Bureau (2016), [enforcement record for Wells Fargo Bank, N.A.](https://www.consumerfinance.gov/enforcement/actions/wells-fargo-bank-2016/). Chapter 13 draws on the regulatory record to discuss unauthorised accounts, sales incentives and the cost to customers, and does not invent month-by-month changes, the inner lives of individual employees or the effects of every reform since.

[^forer]: Bertram R. Forer (1949). “The Fallacy of Personal Validation: A Classroom Demonstration of Gullibility.” *The Journal of Abnormal and Social Psychology, 44*(1), 118–123. [DOI of the original paper](https://doi.org/10.1037/h0059240). Chapter 11 keeps the classroom demonstration, distinguishing the rating of the diagnostic instrument from the rating of the descriptive content, and does not let satisfaction stand in for the ability to discriminate.

[^russell]: Bertrand Russell (1912). *The Problems of Philosophy*, Chapter VI, “On Induction”. [Original text](https://www.gutenberg.org/files/5827/5827-h/5827-h.htm). Chapter 5 keeps the chicken of the original and does not mix in the timing or the holiday of the later turkey version; this book's practical discussion of extrapolation does not claim to have solved the whole problem of induction.

[^klein]: Gary Klein (1998). *Sources of Power: How People Make Decisions*. MIT Press, the interview narratives on intuition and fireground commanders. [Publisher's record](https://mitpress.mit.edu/9780262611466/sources-of-power/). Chapter 9 keeps the incidents the researcher recorded and his questioning after the event, kept apart from accident investigation and real-time measurement of the mind; for the conditions of professional reliability see also Kahneman and Klein (2009).

[^bainbridge]: Lisanne Bainbridge (1983). “Ironies of Automation.” *Automatica, 19*(6), 775–779. [PDF of the original paper](https://tc.ifac-control.org/4/1/newsletter/ironies-of-automation/@@download/file/Bainbridge1983_Automatica_Ironies%20of%20automation.pdf). Chapter 4 adopts its analysis of the manual tasks, the skills and the difficulty of taking over that remain after automation.

[^placebo]: Ted J. Kaptchuk et al. (2010). “Placebos without Deception: A Randomized Controlled Trial in Irritable Bowel Syndrome.” *PLOS ONE, 5*(12), e15591. [Full text of the study](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0015591). Chapter 11 is limited to the study's short-term, self-reported symptom outcomes and its research conditions.

[^cast]: Cardiac Arrhythmia Suppression Trial Investigators (1989). “Preliminary Report: Effect of Encainide and Flecainide on Mortality in a Randomized Trial of Arrhythmia Suppression after Myocardial Infarction.” *New England Journal of Medicine, 321*, 406–412. [Record of the original paper](https://pubmed.ncbi.nlm.nih.gov/2473403/), [NHLBI study database description](https://biolincc.nhlbi.nih.gov/studies/cast/). Chapter 14 draws on the results of the specific treatment arms to discuss the difference between surrogate indicators and survival outcomes.

[^peirce]: Charles S. Peirce (1877). “The Fixation of Belief.” *Popular Science Monthly, 12*, 1–15. [Original text](https://www.peirce.org/writings/p107.html). Chapters 8 and 15 use it to locate the intellectual source of the discussion of belief and inquiry, and do not use it to reduce pragmatism to "whatever is useful is true".

[^dewey]: John Dewey (1910). *How We Think*. D. C. Heath. [Full text of the 1910 edition](https://www.gutenberg.org/cache/epub/37423/pg37423-images.html). Chapters 8 and 15 carry forward its discussion of reflection, concrete difficulties and checking; the promise case and the bounded analysis steps in the main text are this book's own construction.

[^resource]: Falk Lieder & Thomas L. Griffiths (2020). “Resource-rational Analysis: Understanding Human Cognition as the Optimal Use of Limited Computational Resources.” *Behavioral and Brain Sciences, 43*, e1. [PDF of the paper and commentaries](https://cocosci.princeton.edu/papers/liederresource.pdf). Chapters 12 and 16 use it to describe a line of research that brings cognitive cost into the analysis. The forty-minute study arrangement in the main text is a hypothetical example for illustration, not an intervention this research has tested; nor does the resource-rational framework guarantee that people in fact always allocate their thinking optimally.

[^smell]: Wen Li, Isabel Moallem, Ken A. Paller & Jay A. Gottfried (2007). “Subliminal Smells Can Guide Social Preferences.” *Psychological Science, 18*(12), 1044–1049. [PDF of the paper provided by the authors](https://faculty.wcas.northwestern.edu/paller/PsychSci07.pdf). Chapter 9 is limited to the effect of odours not consciously detected on specific evaluations, and does not use it to prove that intuition is generally accurate.

[^intuition]: Daniel Kahneman & Gary Klein (2009). “Conditions for Intuitive Expertise: A Failure to Disagree.” *American Psychologist, 64*(6), 515–526. [DOI of the paper](https://doi.org/10.1037/a0016755). Chapter 9 adopts the conditions of environmental regularity and learning feedback, and distinguishes subjective confidence from the reliability of judgement.

[^clotting]: National Heart, Lung, and Blood Institute. “How Blood Clots.” [Official explanation](https://www.nhlbi.nih.gov/health/clotting-disorders/how-blood-clots). Chapter 9 uses it for the basic distinction between platelets, clotting proteins and the formation of a clot.

[^spinal]: University of Hawaiʻi. “General Senses and Spinal Cord.” *Anatomy and Physiology*. [Open textbook](https://pressbooks-dev.oer.hawaii.edu/anatomyandphysiology2021/chapter/13-general-senses-spinal-cord/). The concepts of the reflex arc, the spinal cord and descending motor regulation that Chapter 9 needs can be found in the Motor Pathways and Reflexes sections of that chapter.

[^brain]: National Institute of Neurological Disorders and Stroke (2012). *Brain Basics: Know Your Brain*. [PDF of the original NINDS booklet, preserved by UTHealth](https://www.uth.edu/stroke-institute/assets/img/resources/know-your-brain-basics.pdf). Chapter 9 takes only the basic anatomical account of different brain regions taking part and working together, and does not treat the booklet's simplified introduction to their division of labour as a one-to-one system architecture.

[^cough]: Stuart B. Mazzone et al. (2011). “Investigation of the Neural Control of Cough and Cough Suppression in Humans Using Functional Brain Imaging.” *Journal of Neuroscience, 31*(8), 2948–2958. [Study record and abstract](https://pubmed.ncbi.nlm.nih.gov/21414916/). Chapter 9 cites the difference in activity between coughing and its suppression, and keeps the distinction between imaging correlations and a complete causal explanation.

[^opiate]: Alyn H. Morice et al. (2007). “Opiate Therapy in Chronic Cough.” *American Journal of Respiratory and Critical Care Medicine, 175*(4), 312–315. [Study record and abstract](https://pubmed.ncbi.nlm.nih.gov/17122382/). Chapter 9 uses the finding that the symptom ratings and the citric acid challenge test did not show the same change, to make the point that different measurements cannot be merged into a single threshold narrative.

[^hutchins]: Edwin Hutchins (1995). “How a Cockpit Remembers Its Speeds.” *Cognitive Science, 19*(3), 265–288. [PDF of the original paper](https://pages.ucsd.edu/~ehutchins/documents/CockpitSpeeds.pdf). Chapters 13 and 15 adopt its analysis of speed markers and the distribution of cognitive work; it is not used to claim that a group necessarily has a single consciousness.

[^extended]: Andy Clark & David J. Chalmers (1998). “The Extended Mind.” *Analysis, 58*(1), 7–19. [Original text provided by the authors](https://consc.net/papers/extended.html). Chapters 13 and 15 list it as a philosophical claim about the boundary of the mind, kept apart from the more limited analysis of external dependence.

[^memory]: Elizabeth F. Loftus & John C. Palmer (1974). “Reconstruction of Automobile Destruction: An Example of the Interaction Between Language and Memory.” *Journal of Verbal Learning and Verbal Behavior, 13*, 585–589. [Original paper](https://www.stanford.edu/class/psych205/papers/Loftus-Palmer-1974.pdf). Chapter 1 keeps the two experiments separate, and does not write the speed estimates and the broken-glass question a week later as one test on the same group of people. The chapter's claim is limited to the difference between the question asked and the later answer that the study showed; it does not infer that memory can be rewritten at will, or that everyone is affected in the same way in every situation.

[^kant]: Immanuel Kant, *Critique of Pure Reason* (1781/1787). [Gutenberg English translation](https://www.gutenberg.org/ebooks/4280). Chapters 1 and 5 use it as the intellectual background on sensibility, concepts and the status of geometry; the bearing of non-Euclidean geometry on Kant's thought is still disputed among interpreters, and a brief case is not used to declare his whole epistemology void. The chapter discusses the problem that non-Euclidean geometry poses for Kant's argument about geometry, and does not use a spherical diagram or a single mathematical development to declare his whole epistemology overturned.

[^tetlock]: Philip E. Tetlock (2005). *Expert Political Judgment: How Good Is It? How Can We Know?* Princeton University Press. [Digital copy of the book](https://archive.org/download/expert-political-judgment/Expert%20Political%20Judgment%20How%20Good%20Is%20It%20How%20Can%20We%20Know.pdf). Chapter 6 adopts the research design of long-term tracking and comparison of forecasts; the weather figures for calibration and discrimination are this book's own example. The chapter does not use one general comparison to pass judgement on all experts, nor does it treat calibration as wholly unrelated to intelligence or professional knowledge; the research should be understood by its questions, its baselines and its scoring.

[^representation]: Jill H. Larkin & Herbert A. Simon (1987). “Why a Diagram Is (Sometimes) Worth Ten Thousand Words.” *Cognitive Science, 11*(1), 65–100. [DOI of the original paper](https://doi.org/10.1111/j.1551-6708.1987.tb00863.x). Chapter 3 carries forward the distinction between informational and computational equivalence; the multiplication of numbers and the route diagram are this book's teaching constructions.

[^vietnam]: Gregory A. Daddis (2011). *No Sure Victory: Measuring U.S. Army Effectiveness and Progress in the Vietnam War*. Oxford University Press. [Publisher's record](https://global.oup.com/academic/product/no-sure-victory-9780199746873). Chapter 4 uses the many performance metrics and the difficulty of reading them to discuss strategic judgement; this analysis does not amount to a single cause of the war's outcome.

[^cosmology]: NASA Science, [Building Blocks](https://science.nasa.gov/universe/overview/building-blocks/). Chapter 4 uses it only to distinguish dark matter, dark energy and their observational background, and does not claim that the ultimate physical nature of either is known.

[^astronomy]: Thomas S. Kuhn (1957). *The Copernican Revolution*. Harvard University Press; NASA Science, [Orbits and Kepler’s Laws](https://science.nasa.gov/solar-system/orbits-and-keplers-laws/). Chapter 11 keeps the comparison of calculation and theory in the history of astronomy apart from the basic account of modern orbits; it does not repeat the contrast of "degrees for the old tables, arcseconds for the new", which comes without the object, the period and the precision conditions attached.

[^mindfulness]: Jon Kabat-Zinn (2003). “Mindfulness-Based Interventions in Context: Past, Present, and Future.” *Clinical Psychology: Science and Practice, 10*(2), 144–156. [DOI of the original paper](https://doi.org/10.1093/clipsy.bpg016). Chapter 11 uses it for the formation of mindfulness-based stress reduction and its traditional background; it does not say that every ethical context has been removed by the course, nor does it claim in general that every use is effective.

[^geometry]: Euclid, *Elements*, [the Greek text of the geometry with mathematical commentary](https://mathcs.clarku.edu/~djoyce/elements/); Girolamo Saccheri, *Euclides ab omni naevo vindicatus* (1733); Bernhard Riemann, “Über die Hypothesen, welche der Geometrie zu Grunde liegen” (lecture 1854, published 1868). The spherical diagram in Chapter 5 is a mathematical illustration, not a complete proof of the independence of the postulate.

[^relativity]: Neil Ashby (2003). “Relativity in the Global Positioning System.” *Living Reviews in Relativity, 6*, 1. [Full text of the study](https://doi.org/10.12942/lrr-2003-1). Chapter 5 adopts the explanation that comparing times requires relativistic correction; it does not treat one idealised conversion as a fixed daily positioning error for every receiver. The actual positioning error depends on the system's configuration and corrections, and cannot be obtained by simply multiplying a time difference by the speed of light and treating the result as a fixed daily position offset borne by every user.

[^climate]: IPCC (2021). *Climate Change 2021: The Physical Science Basis*, [Chapter 1](https://www.ipcc.ch/report/ar6/wg1/chapter/chapter-1/), [Chapter 5](https://www.ipcc.ch/report/ar6/wg1/chapter/chapter-7/). Chapter 5 distinguishes model ensembles, sensitivity ranges and emission scenarios. The assessed ranges carry their own confidence levels; the use of RCP8.5 does not automatically make it the most likely future, or a strict upper bound on all futures.

[^eclipse]: F. W. Dyson, A. S. Eddington & C. Davidson (1920). “A Determination of the Deflection of Light by the Sun’s Gravitational Field, from Observations Made at the Total Eclipse of May 29, 1919.” *Philosophical Transactions of the Royal Society A, 220*, 291–333. [Original paper](https://royalsocietypublishing.org/rsta/article/220/571-581/291/40498/IX-A-determination-of-the-deflection-of-light-by). Chapter 14 keeps the expeditions, the measurements and the test of the theory apart, and does not add inner monologue for the observers. The chapter does not treat every plate as equally clear and fully consistent with the others, nor does it equate one measurement with the sole verdict on an entire theory.

[^popper]: Karl R. Popper (1963). *Conjectures and Refutations*, Chapter 1; Popper (1978). “Natural Selection and the Emergence of Mind.” *Dialectica, 32*(3–4), 339–355. [DOI of the 1978 article](https://doi.org/10.1111/j.1746-8361.1978.tb01321.x). Chapter 14 distinguishes the claim about testability, Popper's own account of himself and his revision regarding natural selection.

[^finches]: Peter T. Boag & Peter R. Grant (1981). “Intense Natural Selection in a Population of Darwin’s Finches (Geospizinae) in the Galápagos.” *Science, 214*(4516), 82–85. [DOI of the original paper](https://doi.org/10.1126/science.214.4516.82). Chapter 14 uses the comparison of specific traits, food and survival to illustrate testable content, and does not treat one observation as the sole verdict on the whole theory of evolution.

[^ether]: Albert A. Michelson & Edward W. Morley (1887). “On the Relative Motion of the Earth and the Luminiferous Æther.” [Transcription of the original paper](https://www.gutenberg.org/cache/epub/70888/pg70888-images.html). Chapter 14 describes a fringe shift far smaller than expected; it does not write that the instrument produced no interference fringes, nor does it compress the whole later development of theory into a single overturning on the day.

[^semmelweis]: Ignaz Semmelweis (1861). *Die Aetiologie, der Begriff und die Prophylaxis des Kindbettfiebers*. [Record of the book, with images and partial translation](https://www.jameslindlibrary.org/semmelweis-i-1861/). Chapter 14 follows his record for the comparison of the clinics, the contamination hypothesis and the washing measures; the professional and emotional cost that admitting error may involve is raised in the main text as a general analysis, and is not used to pronounce on the motives of each historical figure.

[^kuhn]: Thomas S. Kuhn (1977). *The Essential Tension: Selected Studies in Scientific Tradition and Change*. University of Chicago Press, the preface's retrospective on reading Aristotle. [Digital copy of the book](https://social-ecology.org/wp/wp-content/uploads/2022/08/The_Essential_Tension_Thomas_S_Kuhn.pdf). Chapter 7 treats it as the author's retrospective, distinguishing understanding the meaning of the words, accepting a historical theory and the formation of the later work. The recollection is used to show how the use of concepts is reconstructed in reading; it does not mean that all of Aristotle's claims in physics thereby hold, nor does it ascribe the formation of *The Structure of Scientific Revolutions* to a single moment of insight.

[^haidt]: Jonathan Haidt (2012). *The Righteous Mind: Why Good People Are Divided by Politics and Religion*. Pantheon, his own account of fieldwork in India in 1993. [The author's website for the book](https://righteousmind.com/). Chapter 7 does not generalise a particular visitor's experience into the position of a whole culture, and it keeps the different consequences that people of different standing may bear.

[^yijing]: The *Yijing* (*Zhouyi*): the hexagram statements, the line statements and the Ten Wings; [text of the *Zhouyi*](https://ctext.org/book-of-changes/zh). Chapter 8 keeps apart the combinations of symbols, the textual layers and the interpretive traditions. This book's "using yin and yang as a way of asking questions" is a contemporary appropriation, not evidence of the predictive validity of divination.

[^leibniz]: Gottfried Wilhelm Leibniz (1703). “Explication de l’arithmétique binaire, qui se sert des seuls caractères 0 et 1, avec des remarques sur son utilité, et sur ce qu’elle donne le sens des anciennes figures chinoises de Fohy.” [English translation of the original](https://leibniz-translations.com/binary). Chapter 8 distinguishes the binary arithmetic already developed, the hexagram diagram obtained later and the attribution of historical intent.

[^qwerty]: Koichi Yasuoka & Motoko Yasuoka (2011). “On the Prehistory of QWERTY.” [Original study in the Kyoto University repository](https://repository.kulib.kyoto-u.ac.jp/handle/2433/139379). Chapter 8 uses it to examine the popular story that the layout was "designed to slow typists down", and does not declare one interpretation of the sources in it to be the undisputed and complete origin.

[^y2k]: U.S. General Accounting Office (2000). *Year 2000 Computing Challenge: Lessons Learned Can Be Applied to Other Management Challenges*. GAO/AIMD-00-290. [Official report](https://www.govinfo.gov/content/pkg/GAOREPORTS-AIMD-00-290/pdf/GAOREPORTS-AIMD-00-290.pdf). Chapter 8 keeps the inventory, the remediation, the testing and the contingency planning, and does not adopt global total-cost figures that have not been separately verified.

[^simon]: Herbert A. Simon (1978). “Rational Decision-Making in Business Organizations.” [Nobel lecture and text](https://www.nobelprize.org/prizes/economic-sciences/1978/simon/lecture/); Simon (1990). “Invariants of Human Behavior.” *Annual Review of Psychology, 41*, 1–19. [DOI of the original paper](https://doi.org/10.1146/annurev.ps.41.020190.000245). The bounded rationality, satisficing and scissors metaphor of Chapter 12 follow, respectively, his decision research and his later synthesis, and do not pass off every sentence of the scissors metaphor as the words of the prize lecture.

[^skill]: John R. Anderson (1982). “Acquisition of Cognitive Skill.” *Psychological Review, 89*(4), 369–406. [DOI of the original paper](https://doi.org/10.1037/0033-295X.89.4.369). Chapter 9 uses it for explicit knowledge, practice and procedural ability; it does not assign every emotional change, tacit learning or intuition to the same compilation mechanism.

[^hindsight]: Baruch Fischhoff & Ruth Beyth (1975). “I Knew It Would Happen: Remembered Probabilities of Once-Future Things.” *Organizational Behavior and Human Performance, 13*, 1–16. [PDF of the original paper](https://web.mit.edu/curhan/www/docs/Articles/biases/13_Org_Behavior_and_Human_Perf_13_1975_Fischhoff.pdf). Chapter 9 distinguishes the drift of memory that a record of predictions can prevent from the gaps in choice, sampling and counterfactuals that a record cannot fill.

[^catch]: Michael K. McBeath, Dennis M. Shaffer & Mary K. Kaiser (1995). “How Baseball Outfielders Determine Where to Run to Catch Fly Balls.” *Science, 268*, 569–573. [DOI of the original paper](https://doi.org/10.1126/science.7725104), [the authors' public copy](https://redfish.com/papers/McBeath-BaseballCatch.pdf). Chapter 9 discusses continuous visual feedback; the study's model has its conditions and cannot be turned into "keep the angle of elevation constant and the catch is guaranteed". Carrying a bowl of water is an everyday example used to illustrate continuous adjustment, and it is not concluded from this that the two activities share the same neural mechanism.

[^hanoi]: Michael G. Vann (2003). “Of Rats, Rice, and Race: The Great Hanoi Rat Massacre, an Episode in French Colonial History.” *French Colonial History, 4*, 191–203. [DOI of the study](https://doi.org/10.1353/fch.2003.0027). Chapter 13 retells the episode from this study of the historical archives, and does not add the names, dialogue or personal motives of the rat-catchers, or invented scenes of administrative decision-making.

[^metrics]: Charles A. E. Goodhart (1975). “Problems of Monetary Management: The U.K. Experience”; Donald T. Campbell (1976). *Assessing the Impact of Planned Social Change*, [original report](https://www.humanlearning.systems/uploads/08%20Assessing%20the%20Impact%20of%20Planned%20Social%20Change.pdf); Marilyn Strathern (1997). “‘Improving Ratings’: Audit in the British University System.” *European Review, 5*(3), 305–321, [publisher's page for the paper](https://www.cambridge.org/core/journals/european-review/article/improving-ratings-audit-in-the-british-university-system/FC2EE640C0C44E3DB87C29FB666E9AAB). Chapter 13 keeps the three authors and the background to their problems apart; the main text paraphrases rather than quotes. The wording now common, "when a measure becomes a target", is closely related to Strathern's text of 1997; the contexts and phrasing of Goodhart, Campbell and Strathern each differ, and they should not be treated as different signatures on the same sentence.

[^nhs]: Ellen J. Weber, Suzanne Mason, Adrian Carter & Rachel L. Hew (2011). “Emptying the Corridors of Shame: Organizational Lessons from England’s 4-Hour Emergency Throughput Target.” *Annals of Emergency Medicine, 57*(2), 79–88.e1. [Study record](https://europepmc.org/article/MED/21251521), [DOI of the original paper](https://doi.org/10.1016/j.annemergmed.2010.08.013). The study interviewed emergency-department leaders at nine hospitals between June and August 2008 and was published in 2011. It is an interview study of organisational experience; the changes reported by the interviewees must be distinguished from research that measures clinical outcomes directly.

[^dsm]: American Psychiatric Association, [DSM-5 explanation of autism spectrum disorder](https://www.psychiatry.org/File%20Library/Psychiatrists/Practice/DSM/APA_DSM-5-Autism-Spectrum-Disorder.pdf), [care of LGBTQ patients and the historical background](https://www.psychiatry.org/getmedia/1dd0b752-8791-49d0-b8a1-c73d853bd610/Best-Practices-LGBTQ-Patients.pdf); U.S. Department of Veterans Affairs, [PTSD History and Overview](https://www.ptsd.va.gov/professional/treat/essentials/history_ptsd.asp). Chapter 13 discusses the history of revisions and the social work that classifications do; it does not offer individual diagnosis, nor does it equate a classification with the benefits paid in each place.

[^hacking]: Ian Hacking (2007). “Kinds of People: Moving Targets.” *Proceedings of the British Academy, 151*, 285–318. [The author's lecture paper](https://www.thebritishacademy.ac.uk/documents/2043/pba151p285.pdf). Chapter 13 adopts the interaction between a classification and those classified, and does not infer from looping effects that illness or suffering is fictitious.

[^screening]: U.S. Preventive Services Task Force (2009). “Screening for Breast Cancer: Recommendation Statement.” *Annals of Internal Medicine, 151*, 716–726. [Official text of the recommendation from that year](https://www.uspreventiveservicestaskforce.org/Home/GetFile/1/406/brcanrs/pdf). Chapter 16 treats this as a historical case, not as the current screening recommendation. The main text also states explicitly that it uses hypothetical numbers to explain the denominator, and does not treat them as medical risk estimates.

[^values]: Richard Rudner (1953). “The Scientist Qua Scientist Makes Value Judgments.” *Philosophy of Science, 20*(1), 1–6, [publisher's page for the paper](https://www.cambridge.org/core/journals/philosophy-of-science/article/scientist-qua-scientist-makes-value-judgments/BA23A8340EB3039A50C4177AEE2C2A5C); Heather Douglas (2000). “Inductive Risk and Values in Science.” *Philosophy of Science, 67*(4), 559–579, [DOI of the original paper](https://doi.org/10.1086/392855). Chapter 16 distinguishes the role of values in bearing the risk of error from rewriting facts at will according to values; this is an argued position, not an uncontested definition.

[^leaky]: Joel Spolsky (2002-11-11). “The Law of Leaky Abstractions.” [The author's original text](https://www.joelonsoftware.com/2002/11/11/the-law-of-leaky-abstractions/). Chapter 4 keeps the name "leaky abstraction", separating the empirical generalisation from engineering from the cross-domain argument this book makes on its own account; the example of two sets of data with the same summary where a new question demands different answers offers a necessity argument with explicit premises, and does not claim that one engineering article proves every abstraction must be wrong for every use.
...
[^lean]: *Theorem Proving in Lean 4*, [Introduction](https://lean-lang.org/theorem_proving_in_lean4/Introduction/) and [Axioms and Computation](https://lean-lang.org/theorem_proving_in_lean4/Axioms-and-Computation/), official Lean documentation, checked on 2026-09-11. Formalisation requires that propositions be stated precisely, and proofs are checked against definitions, axioms and the rules of logic. Passing the check does not by itself guarantee that the formal model covers every relevant condition in reality. This book draws from it a discussion of the value of thinking that can be carried on by others; that extension is not a full philosophical claim made by the official documentation.
...
[^perspective]: Tal Eyal, Mary Steffel, and Nicholas Epley (2018). “Perspective Mistaking: Accurately Understanding the Mind of Another Requires Getting Perspective, Not Taking Perspective.” *Journal of Personality and Social Psychology* 114(4): 547–571. [Original paper](https://doi.org/10.1037/pspa0000115). The paper reports twenty-five experiments; imagining another person's perspective did not consistently improve the accuracy of judgement, while arrangements in which information was obtained through conversation did. Chapter 8 uses it to distinguish reconstructing thoughts from obtaining information; the conclusion is limited to the tasks tested and is not extended into a claim that empathy, imagination or historical understanding is generally ineffective.

[^analects]: *Analects*, “Wei Zheng,” on learning without thought and thought without learning. [Chinese Text Project original](https://ctext.org/analects/wei-zheng/zh). Chapter 8 develops a movement between receiving earlier material and reorganising and testing it. This extension belongs to the present book.

[^xunzi]: *Xunzi*, “Encouraging Learning,” on making good use of things, including its images of height, wind, boats, and carriages. [Chinese Text Project original](https://ctext.org/xunzi/quan-xue/zh). Chapter 6 uses the passage to discuss abilities supported by tools, people, and institutions, without attributing modern distributed cognition theory to Xunzi.

[^zhuangzi-outer]: *Zhuangzi*, “External Things,” on the fish trap and forgetting it once the fish is obtained. [Chinese Text Project original](https://ctext.org/text.pl?if=zh&node=2956). Chapter 3 develops the relationship into a discussion of representations receding from attention while retaining ways to inspect them. The latter is this book’s extension to information systems.

[^zhongyong]: *Book of Rites*, “Doctrine of the Mean,” on broad learning, careful questioning, reflection, discrimination, and practice. [Chinese Text Project original](https://ctext.org/text.pl?if=zh&node=10282). Chapter 14 discusses the sequence and adds an argument for returning from outcomes to revision.

[^aristotle]: Aristotle, *Nicomachean Ethics*, Books III and VI. [MIT Internet Classics Archive text](https://classics.mit.edu/Aristotle/nicomachaen.html). Chapters 10, 5, and 12 respectively draw on deliberation, practical wisdom’s attention to particulars, and matters alterable through action. This book’s framework is not attributed to Aristotle.

[^james]: William James (1907), *Pragmatism: A New Name for Some Old Ways of Thinking*, especially Lectures II and VI. [Project Gutenberg text](https://www.gutenberg.org/ebooks/5116). Chapter 11 distinguishes pragmatism from equating comfort with truth. This book evaluates statements’ truth separately from capacities provided by an understanding.

[^cybernetics]: Heinz von Foerster, 'Cybernetics of Cybernetics'. [Full article](https://reflexus.org/wp-content/uploads/foerster_cybernetics-of-cybernetics.pdf). The discussion of observers and purposes follows its account of observing systems. It does not treat second-order cybernetics as a single, undivided school or derive all this book's normative claims from it.

[^longino]: Helen E. Longino (1996), 'Cognitive and Non-Cognitive Values in Science: Rethinking the Dichotomy', in Lynn Hankinson Nelson and Jack Nelson, eds., *Feminism, Science, and the Philosophy of Science*, 39–58. [Full article](https://joelvelasco.net/teaching/5330/longino1996.pdf). The four community conditions for criticism appear on pp. 40–41. This book's questions about data handovers and paths to decisions develop an analysis from them rather than reproduce the article's claims verbatim.

[^equilibrium]: Norman Daniels, 'Reflective Equilibrium', *Stanford Encyclopedia of Philosophy*. [Discussion of the method](https://plato.stanford.edu/entries/reflective-equilibrium/). The text follows its account of reciprocal adjustment among particular judgements, principles, and background theories. For Rawls's discussion, see John Rawls, *A Theory of Justice*, section 9. Reflective equilibrium has different versions; it is not reduced here to a test of consistency detached from action.
